    ...
    <div className="card">
      ...
      <div className="card-footer">
        <div>
          ...
          <span style={{color: '#666', fontSize: '10px', display: 'flex', gap: '4px', lineHeight: '1.2'}}>
            <svg width="10" height="10" viewBox="0 0 24 24" fill="#ff3d00" style={{verticalAlign:'baseline'}}>
